 ...
 * for both botcoind and botcoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Botcoin");


#include <botcoin-build-info.h>
// The <botcoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Botcoin Core copyright is not removed by accident
    if (copyright_devs.find("Botcoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Botcoin Core developers";
    }
